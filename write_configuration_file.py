...
def main():
    ...
    parser.add_argument('--virus_database', required = False, default = "virus.fa", help = "")
    parser.add_argument('--bowtie_index_human', required = False, default = "GRCh38.genome", help = "")
    parser.add_argument('--blastn_index_human', required = False, default = "GRCh38.genome", help = "")
    parser.add_argument('--blastn_index_virus', required = False, default = "virus", help = "")
